const discord = require ('discord.js');
 ...
 client.on ("message", (message) => {
    ...
    if (msg.startsWith(prefix + "quiz")) {
        ...
        switch (random4) {
            case 1: message.channel.send ("How amazing is aziz: \n`A ) Godly \nB ) Amazing \nC ) Okay \nD ) Meh`"); cAnswer = "a"; break;
    ...
    if (msg.startsWith (prefix + "helpp")) {
        embed2 = new discord.RichEmbed ()
            ...
            .setFooter ("This commands was created by Shichibukai.")
            .setColor ("00ff00")
    ...
    if (msg.startsWith (prefix + "creator")) {
        ...
        .setDescription ("Credits to Shichibukai for : \n coding and creating me !")
        .setFooter ("Thank Shichibukai for creating me!")
    ...
    if(message.content.startsWith(`${prefix}createchannel`)) {
        ...
        message.guild.createChannel(`${args}`).then(channel => {
            channel.setTopic(`This is Shichibukai channel!`)
        })
    }
